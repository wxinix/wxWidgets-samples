...
enum
{
    ...
    OleAuto_Text [[maybe_unused]] = 1000
};
...
bool MyApp::OnInit()
{
    ...
    auto *frame = new MyFrame("OleAuto wxWidgets App", wxPoint(50, 50), wxSize(450, 340));
...
// frame constructor
MyFrame::MyFrame(const wxString &title, const wxPoint &pos, const wxSize &size) : wxFrame((wxFrame *)nullptr, wxID_ANY, title, pos, size)
{
    // set the frame icon
 ...
 */
void MyFrame::OnTest(wxCommandEvent &WXUNUSED(event)) // NOLINT(*-convert-member-functions-to-static)
{
