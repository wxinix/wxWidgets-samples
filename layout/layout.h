...
{
public:
    explicit MyProportionsFrame(wxFrame *parent);
...
{
public:
    explicit MyFlexSizerFrame(wxFrame* parent);
...
{
public:
    explicit MyGridBagSizerFrame(wxFrame* parent);
...
{
public:
    explicit MySimpleSizerFrame(wxFrame* parent);
...
{
public:
    explicit MyNestedSizerFrame(wxFrame* parent);
...
{
public:
    explicit MyWrapSizerFrame(wxFrame* parent);
