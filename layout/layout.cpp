...
MyFrame::MyFrame() : wxFrame(nullptr, wxID_ANY, "wxWidgets Layout Demo")
{
    ...
    auto* p = new wxPanel(this, wxID_ANY);
    ...
    wxBoxSizer *static_sizer = new wxStaticBoxSizer(
    ...
    auto *grid_sizer = new wxGridSizer(2, 5, 5);
    grid_sizer->Add(new wxStaticText(p, wxID_ANY, "Label"),
                wxSizerFlags().Align(wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL));
    grid_sizer->Add(new wxTextCtrl(p, wxID_ANY, "Grid sizer demo"),
                wxSizerFlags(1).Align(wxGROW | wxALIGN_CENTER_VERTICAL));
    grid_sizer->Add(new wxStaticText(p, wxID_ANY, "Another label"),
                wxSizerFlags().Align(wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL));
    grid_sizer->Add(new wxTextCtrl(p, wxID_ANY, "More text"),
                wxSizerFlags(1).Align(wxGROW | wxALIGN_CENTER_VERTICAL));
    grid_sizer->Add(new wxStaticText(p, wxID_ANY, "Final label"),
                wxSizerFlags().Align(wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL));
    grid_sizer->Add(new wxTextCtrl(p, wxID_ANY, "And yet more text"),
...
void MyFrame::OnAbout(wxCommandEvent& WXUNUSED(event) ) //NOLINT
{
...
MyProportionsFrame::MyProportionsFrame(wxFrame *parent) : wxFrame(parent, wxID_ANY, "Box Sizer Proportions Demo")
{
    // create the controls
    auto *panel = new wxPanel(this, wxID_ANY);
    for(int n = 0; n < WXSIZEOF(m_spins); n++)
    {
    ...
    for(auto & m_spin : m_spins)
        m_sizer->Add(m_spin, wxSizerFlags().Border());
...
void MyFlexSizerFrame::InitFlexSizer(wxFlexGridSizer *sizer, wxWindow* parent) //NOLINT
{
    for ( int i = 0; i < 3; i++ )
    {
        for ( int j = 0; j < 3; j++ )
            ...
            : wxFrame(parent, wxID_ANY, "Flex Sizer Test Frame")
{
    ...
    sizerCol1->Add(new wxStaticText(p, wxID_ANY, "Un-growable:"), 0, wxCENTER | wxTOP, 20);
    ...
    auto *sizerTop = new wxGridSizer(2, 0, 20);
                        ...
                        wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)
{
    ...
    auto *button = new wxButton( this, wxID_OK, "OK" );
    topsizer->Add( button, 0, wxALIGN_RIGHT | wxALL, 10 );

    // First page: one big text ctrl
    auto *multi = new wxTextCtrl( notebook, wxID_ANY, "TextCtrl.", wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE );
    ...
    auto *text = new wxTextCtrl( panel, wxID_ANY, "TextLine 1.", wxDefaultPosition, wxSize(250,wxDefaultCoord) );
    panel_sizer->Add( text, 0, wxGROW|wxALL, 30 );
    text = new wxTextCtrl( panel, wxID_ANY, "TextLine 2.", wxDefaultPosition, wxSize(250,wxDefaultCoord) );
    panel_sizer->Add( text, 0, wxGROW|wxALL, 30 );
    auto *button2 = new wxButton( panel, wxID_ANY, "Hallo" );
    panel_sizer->Add( button2, 0, wxALIGN_RIGHT | wxLEFT|wxRIGHT|wxBOTTOM, 30 );
              ...
              wxDefaultPosition, wxSize(200,-1))
{
    ...
    auto *topSizer = new wxStaticBoxSizer( wxVERTICAL, this, "Wrapping check-boxes" );
